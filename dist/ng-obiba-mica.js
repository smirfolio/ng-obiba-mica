...
angular.module("search/components/criteria/item-region/node/component.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("search/components/criteria/item-region/node/component.html",
    "<span>\n" +
