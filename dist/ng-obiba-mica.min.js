...
angular.module("obiba.mica.search",["obiba.alert","ui.bootstrap","pascalprecht.translate","templates-ngObibaMica"]).config(["$provide",function(a){a.provider("ngObibaMicaSearchTemplateUrl",(new NgObibaMicaTemplateUrlFactory).create({list:{header:null,footer:null},view:{header:null,footer:null},form:{header:null,footer:null}}))}]),angular.module("obiba.mica.search").constant("QUERY_TYPES",{NETWORKS:"networks",STUDIES:"studies",DATASETS:"datasets",VARIABLES:"variables"}).constant("DISPLAY_TYPES",{LIST:"list",COVERAGE:"coverage",GRAPHICS:"graphics"}).controller("SearchController",["$scope","$timeout","$routeParams","$location","TaxonomiesSearchResource","TaxonomiesResource","TaxonomyResource","VocabularyResource","ngObibaMicaSearchTemplateUrl","JoinQuerySearchResource","JoinQueryCoverageResource","QUERY_TYPES","DISPLAY_TYPES","AlertService","ServerErrorUtils","LocalizedValues","ObibaSearchConfig",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q){function r(b,c,d,e){var f=c.name+"::"+d.name;e&&(f=f+":"+e.name);var g={id:f,taxonomy:c,vocabulary:d,term:e,target:b,lang:a.lang,itemTitle:"",itemDescription:"",itemParentTitle:"",itemParentDescription:""};
// prepare some labels for display
return e?(g.itemTitle=p.forLocale(e.title,a.lang),g.itemDescription=p.forLocale(e.description,a.lang),g.itemParentTitle=p.forLocale(d.title,a.lang),g.itemParentDescription=p.forLocale(d.description,a.lang),g.itemTitle||(g.itemTitle=e.name),g.itemParentTitle||(g.itemParentTitle=d.name)):(g.itemTitle=p.forLocale(d.title,a.lang),g.itemDescription=p.forLocale(d.description,a.lang),g.itemParentTitle=p.forLocale(c.title,a.lang),g.itemParentDescription=p.forLocale(c.description,a.lang),g.itemTitle||(g.itemTitle=d.name),g.itemParentTitle||(g.itemParentTitle=c.name)),g}function s(a){n.alert({id:"SearchController",type:"danger",msg:o.buildMessage(a),delay:5e3})}function t(a){if(!a||!l[a.toUpperCase()])throw new Error("Invalid type: "+a)}function u(a){if(!a||!m[a.toUpperCase()])throw new Error("Invalid display: "+a)}function v(a){var b=":q(match())";switch(a){case l.NETWORKS:return b.replace(/:q/,"network");case l.STUDIES:return b.replace(/:q/,"study");case l.DATASETS:return b.replace(/:q/,"dataset");case l.VARIABLES:return b.replace(/:q/,"variable")}throw new Error("Invalid query type: "+a)}function w(){try{var b=d.search(),c=b.type||l.VARIABLES,e=b.display||m.LIST,f=b.query||v(c);return t(c),u(e),(new RqlParser).parse(f),a.search.type=c,a.search.display=e,a.search.query=f,!0}catch(g){n.alert({id:"SearchController",type:"danger",msg:g.message,delay:5e3})}return!1}function x(a){var b=[],c=[],d=[],e={},f={total:[]};
// compute totalHits for each row
return a.taxonomies&&a.taxonomies.forEach(function(a){if(a.vocabularies){var g=0;a.vocabularies.forEach(function(b){b.terms&&(b.terms.forEach(function(c){g++,d.push({taxonomy:a.taxonomy,vocabulary:b.vocabulary,term:c.term}),f.total.push(c.hits),c.buckets&&c.buckets.forEach(function(a){a.field in e||(e[a.field]={}),a.value in e[a.field]||(e[a.field][a.value]={field:a.field,title:a.title,description:a.description,hits:{}}),
// store the hits per field, per value at the position of the term
e[a.field][a.value].hits[g]=a.hits})}),c.push({taxonomy:a.taxonomy,vocabulary:b.vocabulary,termsCount:b.terms.length}))}),b.push({taxonomy:a.taxonomy,termsCount:g})}}),Object.keys(e).forEach(function(a){Object.keys(e[a]).forEach(function(b){var c=e[a][b].hits;e[a][b].totalHits=Object.keys(c).map(function(a){return c[a]}).reduce(function(a,b){return a+b})})}),{taxonomyHeaders:b,vocabularyHeaders:c,termHeaders:d,rows:e,footers:f,totalHits:a.totalHits,totalCount:a.totalCount}}function y(){if(w())switch(a.search.result=null,a.search.display){case m.LIST:j[a.search.type]({query:a.search.query},function(b){a.search.result=b},s);break;case m.COVERAGE:a.search.progress=!0;var b=a.search.query,c=(new RqlParser).parse(b),d=new RqlQuery("aggregate"),e=new RqlQuery("bucket");e.args.push("studyIds"),
//bucket.args.push('dceIds');
d.args.push(e),c.args.forEach(function(a){"variable"===a.name&&a.args.push(d)}),b=c.serializeArgs(c.args),k.get({query:b},function(b){a.search.result=x(b)},s);break;case m.GRAPHICS:}}console.log(q.getOptions());var z=function(){angular.element("#taxonomies").collapse("hide")},A=function(b){
// taxonomy filter
