...
y(a.taxonomies.search.text)}},C=function(){var b=(new RqlQuery).serializeArgs(a.search.rqlQuery.args),c=d.search();
// TODO bug when there other queries such as locale etc
""===b?delete c.query:c.query=b,d.search(c).replace()},D=function(){a.documents.search.text=null,a.documents.search.active=!1},E=function(b){
