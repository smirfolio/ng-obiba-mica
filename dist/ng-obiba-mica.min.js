...
a.search.criteria=b.root,a.search.criteria&&a.search.criteria.children&&B(a.search.criteria.children),a.search.criteriaItemMap=b.map,a.search.result={},a.search.query&&C()})}function E(){j.getLocale(function(b){angular.isArray(b)?(a.tabs=b,a.lang=b[0]):a.lang=b||a.lang,r.setLocale(a.lang),s(),D()})}a.options=j.getOptions(),a.taxonomyTypeMap={//backwards compatibility for pluralized naming in configs.
