 ...
 */
CriteriaBuilder.prototype.visitLeaf=function(a,b){var c=RQL_NODE.MATCH===a.name,d=a.args[c?1:0],e=a.args[c?0:1],f=this.fieldToVocabulary(d),g=this.buildLeafItem(f.taxonomy,f.vocabulary,e instanceof Array?e:[e],a,b),h=this.leafItemMap[g.id];h?h instanceof RepeatableCriteriaItem?h.addItem(g):(console.error("Non-repeatable criteria items must be unique,",h.id,"will be overwritten."),h=g):h=g.vocabulary.repeatable?(new RepeatableCriteriaItem).addItem(g):g,this.leafItemMap[g.id]=h,b.children.push(g)},/**
...
return e.map(function(a){return{count:0,"default":0,description:d.forLocale(a.description,c),key:a.name,title:d.forLocale(a.title,c)}})}return a}function g(a,b){if(a.children){var c=a.children.filter(function(a){return a.hasOwnProperty(b)}).pop();if(c)return c[b]}return null}var h=e.vocabularyAlias(b.vocabulary),i=a[b.target+"ResultDto"];if(i&&i.aggs){var j=b.taxonomy.name.startsWith("Mica_"),k=j?h:b.taxonomy.name,l=i.aggs.filter(function(a){return a.aggregation===k}).pop();if(l){if(j)return e.isNumericVocabulary(b.vocabulary)?l["obiba.mica.StatsAggregationResultDto.stats"]:e.isRangeVocabulary(b.vocabulary)?f(l["obiba.mica.RangeAggregationResultDto.ranges"],b.vocabulary):f(l["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary);var m=l.children.filter(function(a){return a.aggregation===h}).pop();if(m)return e.isRangeVocabulary(b.vocabulary)?f(g(l,"obiba.mica.RangeAggregationResultDto.ranges"),b.vocabulary):f(g(l,"obiba.mica.TermsAggregationResultDto.terms"),b.vocabulary)}}return f([],b.vocabulary)}}]),/* global BUCKET_TYPES */
/* global RQL_NODE */
/**
