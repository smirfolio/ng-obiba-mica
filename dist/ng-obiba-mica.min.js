...
var h;
// facet
return d.args.forEach(function(a){"study"===a.name&&(h=a)}),h=new RqlQuery("study"),h.args.push(new RqlQuery(RQL_NODE.MATCH)),d.args.push(h),h.args.push(e),h.args.push(g),d.args.push(new RqlQuery("facet")),d.serializeArgs(d.args)},this.getTargetAggregations=function(a,b,c){/**
