...
u(a.taxonomies.search.text)}},y=function(){a.documents.search.text=null,a.documents.search.active=!1},z=function(b){return a.documents.search.active=!0,console.log(b),b&&1===b.length?(a.documents.search.results=[],void(a.documents.search.active=!1)):(e.get({target:"variable",query:b},function(b){a.documents.search.results=[],b&&b.forEach(function(b){b.vocabularies&&b.vocabularies.forEach(function(c){c.terms&&c.terms.forEach(function(d){a.documents.search.results.length<10&&a.documents.search.results.push({id:b.name+"::"+c.name+":"+d.name,taxonomy:b,vocabulary:c,term:d,target:"variable",lang:a.lang})})})}),a.documents.search.active=!1},function(){a.documents.search.results=[],a.documents.search.active=!1}),a.documents.search.results)},A=function(b){console.log(b),a.selectedCriteria=null},B=function(b){switch(b.keyCode){case 27:// ESC
a.documents.search.active&&y();break;default:a.documents.search.text&&z(a.documents.search.text)}},C=function(b,c){var d=a.taxonomies.taxonomy&&!b||a.taxonomies.vocabulary&&!c;a.taxonomies.taxonomy=b,a.taxonomies.vocabulary=c,d&&u(a.taxonomies.search.text)},D=function(){},E=function(a){if(a){n(a);var b=d.search();b.type=a,d.search(b).replace()}};a.QUERY_TYPES=j,a.lang="en",a.search={query:null,type:null,result:null},a.documents={search:{text:null,active:!1,results:[]}},a.taxonomies={all:e.get({target:"variable"}),search:{text:null,active:!1},target:"variable",taxonomy:null,vocabulary:null},a.headerTemplateUrl=h.getHeaderUrl("view"),a.clearFilterTaxonomies=w,a.searchCriteria=z,a.selectCriteria=A,a.searchKeyUp=B,a.filterTaxonomiesKeyUp=x,a.navigateTaxonomy=C,a.selectTaxonomyTarget=v,a.selectTerm=D,a.closeTaxonomies=t,a.onTypeChanged=E,a.taxonomiesShown=!1,
