...
function c(a){var c=0,d=new RegExp(b,"ig");return a.itemTitle.match(d)?c=10:a.itemDescription&&a.itemDescription.match(d)?c=8:a.itemParentTitle.match(d)?c=6:a.itemParentDescription&&a.itemParentDescription.match(d)&&(c=4),c}return g.get({query:D(b),locale:a.lang,target:a.documents.search.target}).$promise.then(function(d){if(d){var e=[],f=0,g=10;if(d.forEach(function(b){var d=b.target,g=b.taxonomy;g.vocabularies&&g.vocabularies.filter(function(a){return angular.isUndefined(a.attributes)||!angular.isUndefined(a.attributes)&&angular.isUndefined(a.attributes.showSearch)}).forEach(function(b){if(b.terms)b.terms.filter(function(a){return angular.isUndefined(a.attributes)||!angular.isUndefined(a.attributes)&&angular.isUndefined(a.attributes.showSearch)}).forEach(function(h){var i=r.createCriteriaItem(d,g,b,h,a.lang);e.push({score:c(i),item:i}),f++});else{var h=r.createCriteriaItem(d,g,b,null,a.lang);e.push({score:c(h),item:h}),f++}})}),e.sort(function(a,b){return b.score-a.score}),e=e.splice(0,g),f>e.length){var h={query:b,total:f,size:g,message:"Showing "+g+" / "+f,status:"has-warning"};e.push({score:-1,item:h})}return e.map(function(a){return a.item})}return[]})},S=function(a){r.removeCriteriaItem(a),P()},T=function(b,c,d){if(b.id){var e,f=CriteriaIdGenerator.generate(b.taxonomy,b.vocabulary),g=a.search.criteriaItemMap[f];g&&-1!==f.indexOf("dceIds")?(S(g),e="search.criterion.updated",r.addCriteriaItem(a.search.rqlQuery,b,c)):g?(e="search.criterion.updated",r.updateCriteriaItem(g,b,d)):(e="search.criterion.created",r.addCriteriaItem(a.search.rqlQuery,b,c)),o.growl({id:"SearchControllerGrowl",type:"info",msgKey:e,msgArgs:[q.forLocale(b.vocabulary.title,a.lang)],delay:3e3}),P(),a.selectedCriteria=null}else a.selectedCriteria=b.query},U=function(b){switch(b.keyCode){case 27:// ESC
