...
u(a.taxonomies.search.text)}},y=function(){a.documents.search.text=null,a.documents.search.active=!1},z=function(a){
// search for taxonomy terms
// search for matching variables/studies/... count
return e.get({query:a}).$promise.then(function(a){if(a){var b=[],c=0;return a.forEach(function(a){var d=a.target,e=a.taxonomy;e.vocabularies&&e.vocabularies.forEach(function(a){a.terms?a.terms.forEach(function(f){b.length<10&&b.push(n(d,e,a,f)),c++}):(b.length<10&&b.push(n(d,e,a)),c++)})}),b}return[]})},A=function(b){console.log(b),a.selectedCriteria=null},B=function(b){switch(b.keyCode){case 27:// ESC
a.documents.search.active&&y();break;default:a.documents.search.text&&z(a.documents.search.text)}},C=function(b,c){var d=a.taxonomies.taxonomy&&!b||a.taxonomies.vocabulary&&!c;a.taxonomies.taxonomy=b,a.taxonomies.vocabulary=c,d&&u(a.taxonomies.search.text)},D=function(a,b,c,d){A(n(a,b,c,d))},E=function(a){if(a){p(a);var b=d.search();b.type=a,d.search(b).replace()}};a.QUERY_TYPES=k,a.lang="en",a.search={query:null,type:null,result:null},a.documents={search:{text:null,active:!1}},a.taxonomies={all:f.get({target:"variable"}),search:{text:null,active:!1},target:"variable",taxonomy:null,vocabulary:null},a.headerTemplateUrl=i.getHeaderUrl("view"),a.clearFilterTaxonomies=w,a.searchCriteria=z,a.selectCriteria=A,a.searchKeyUp=B,a.filterTaxonomiesKeyUp=x,a.navigateTaxonomy=C,a.selectTaxonomyTarget=v,a.selectTerm=D,a.closeTaxonomies=t,a.onTypeChanged=E,a.taxonomiesShown=!1,
