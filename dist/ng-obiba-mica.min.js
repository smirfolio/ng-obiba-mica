...
return console.log(b),e.get({target:"variable",query:b}).$promise.then(function(b){if(b){var c=[];return b.forEach(function(b){b.vocabularies&&b.vocabularies.forEach(function(d){d.terms&&d.terms.forEach(function(e){c.length<10&&c.push({id:b.name+"::"+d.name+":"+e.name,taxonomy:b,vocabulary:d,term:e,target:"variable",lang:a.lang})})})}),c}return[]})},A=function(b){console.log(b),a.selectedCriteria=null},B=function(b){switch(b.keyCode){case 27:// ESC
