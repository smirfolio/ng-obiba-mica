...
CONTAINS:"contains",IN:"in",OUT:"out",EQ:"eq",GT:"gt",GE:"ge",LT:"lt",LE:"le",BETWEEN:"between",MATCH:"match",EXISTS:"exists",MISSING:"missing"},VOCABULARY_TYPES={STRING:"string",INTEGER:"integer",DECIMAL:"decimal"},CriteriaIdGenerator={generate:function(a,b,c){return a&&b?a.name+"."+b.name+(c?"."+c.name:""):void 0}};/**
