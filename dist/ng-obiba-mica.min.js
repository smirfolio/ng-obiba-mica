...
function NgObibaMicaTemplateUrlFactory(){function a(a){var b=a;this.getHeaderUrl=function(a){return a in b?b[a].header:null},this.getFooterUrl=function(a){return a in b?b[a].footer:null}}var b={registry:null};b.setHeaderUrl=function(a,b){a in this.registry&&(this.registry[a].header=b)},b.setFooterUrl=function(a,b){a in this.registry&&(this.registry[a].footer=b)},b.$get=function(){return new a(this.registry)},this.create=function(a){return b.registry=a,b}}function targetToType(a){switch(a.toLocaleString()){case"network":return"networks";case"study":return"studies";case"dataset":return"datasets";case"variable":return"variables"}throw new Error("Invalid target: "+a)}/**
 * Criteria Item builder
 */
function CriteriaItemBuilder(a,b){var c={id:"",taxonomy:[],vocabulary:[],term:null,selectedTerms:[],target:"",lang:b,itemTitle:"",itemDescription:"",itemParentTitle:"",itemParentDescription:""};this.target=function(a){return c.target=a,this},this.taxonomy=function(a){return c.taxonomy=a,this},this.vocabulary=function(a){return c.vocabulary=a,this},this.term=function(a){return c.term=a,this},this.selectedTerm=function(a){return c.selectedTerms.push(a),this},this.selectedTerms=function(a){return c.selectedTerms=a,this},this.build=function(){return c.id=c.taxonomy.name+"::"+c.vocabulary.name,c.term?(c.id+=":"+c.term.name,c.itemTitle=a.forLocale(c.term.title,c.lang),c.itemDescription=a.forLocale(c.term.description,c.lang),c.itemParentTitle=a.forLocale(c.vocabulary.title,c.lang),c.itemParentDescription=a.forLocale(c.vocabulary.description,c.lang),c.itemTitle||(c.itemTitle=c.term.name),c.itemParentTitle||(c.itemParentTitle=c.vocabulary.name)):(c.itemTitle=a.forLocale(c.vocabulary.title,c.lang),c.itemDescription=a.forLocale(c.vocabulary.description,c.lang),c.itemParentTitle=a.forLocale(c.taxonomy.title,c.lang),c.itemParentDescription=a.forLocale(c.taxonomy.description,c.lang),c.itemTitle||(c.itemTitle=c.vocabulary.name),c.itemParentTitle||(c.itemParentTitle=c.taxonomy.name)),c}}/**
 ...
 * @constructor
 */
function AbstractCriteriaBuilder(a,b,c,d){this.target=null,this.root=a,this.taxonomies=b,this.criteriaList=[],this.LocalizedValues=c,this.lang=d,/**
...
return r.buildVariableCriteria(g,a.lang).then(function(a){a.forEach(function(a){G(a)})}),a.search.type=c,a.search.display=e,a.search.query=f,!0}catch(h){n.alert({id:"SearchController",type:"danger",msg:h.message,delay:5e3})}return!1}function y(){if(x())switch(a.search.loading=!0,a.search.display){case m.LIST:j[a.search.type]({query:a.search.query},function(b){a.search.result=b,a.search.loading=!1},s);break;case m.COVERAGE:k.get({query:r.prepareCoverageQuery(a.search.query,["studyIds"])},function(b){a.search.result=b,a.search.loading=!1},s);break;case m.GRAPHICS:
// TODO
a.search.loading=!1}}a.settingsDisplay=q.getOptions();var z=function(){angular.element("#taxonomies").collapse("hide")},A=function(b){
// taxonomy filter
...
angular.module("obiba.mica.search").factory("TaxonomiesSearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesSearchResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomiesResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("JoinQuerySearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQuerySearchResource"),{},{variables:{method:"GET",errorHandler:!0,params:{type:"variables"}},studies:{method:"GET",errorHandler:!0,params:{type:"studies"}},networks:{method:"GET",errorHandler:!0,params:{type:"networks"}},datasets:{method:"GET",errorHandler:!0,params:{type:"datasets"}}})}]).factory("JoinQueryCoverageResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQueryCoverageResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("VocabularyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("VocabularyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).service("ObibaSearchConfig",function(){var a={networks:{showSearchTab:1},studies:{showSearchTab:1},datasets:{showSearchTab:1},variables:{showSearchTab:1}};this.setOptions=function(b){"object"==typeof b&&Object.keys(b).forEach(function(c){c in a&&(a[c]=b[c])})},this.getOptions=function(){return angular.copy(a)}}).service("RqlQueryService",["$q","TaxonomiesResource","LocalizedValues",function(a,b,c){/**
       ...
       * @returns {boolean}
       */
function d(a,b){if(console.log("findNode",a),a instanceof RqlQuery){if(b.accept(a))return!0;a.args&&a.args.some(function(a){return d(a,b)})}return!1}/**
...
var f=null;/**
       ...
       */
this.createCriteria=function(a,b,d,e,f){return new CriteriaItemBuilder(c,f).target(a).taxonomy(b).vocabulary(d).term(e).build()},/**
...
this.variableNode=function(a){return e(a,"variable")},/**
       ...
       * @returns {*}
       */
this.buildVariableCriteria=function(d,e){function g(){var a=h.variableNode(d);if(a){var b=new VariableCriteriaBuilder(a,h.variableTaxonomies,c,e);b.build(),i.resolve(b.getCriteriaList())}}var h=this,i=a.defer();return f?g():b.get({target:"variable"}).$promise.then(function(a){h.variableTaxonomies=a,g()}),i.promise},this.normalizeAggregationFieldName=function(a,b,c){
// TODO complete and create type-based functions
switch(a){case"variable":return"attributes."+b+"__"+c+".und"}throw new Error("Not implemented: "+b+" "+c)},/**
       ...
       */
this.prepareCriteriaTermsQuery=function(a,b,c,d){var e=(new RqlParser).parse(b),f=new RqlQuery("aggregate"),g=new RqlQuery("facet");return f.args.push(this.normalizeAggregationFieldName(a,c,d)),e.args.some(function(b){return b.name===a?(b.args.push(f),!0):!1}),e.args.push(g),e.serializeArgs(e.args)},/**
