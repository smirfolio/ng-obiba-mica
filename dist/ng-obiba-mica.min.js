...
return d.map(function(a){return{count:0,"default":0,description:c.forLocale(a.description,e),key:a.name,title:c.forLocale(a.title,e)}})}return a}var g=d.vocabularyAlias(b.vocabulary),h=a[b.target+"ResultDto"];if(h&&h.aggs){var i=b.taxonomy.name.startsWith("Mica_"),j=i?g:b.taxonomy.name,k=h.aggs.filter(function(a){return a.aggregation===j}).pop();if(k){if(i)return d.isNumericVocabulary(b.vocabulary)?k["obiba.mica.StatsAggregationResultDto.stats"]:d.isRangeVocabulary(b.vocabulary)?f(k["obiba.mica.RangeAggregationResultDto.ranges"],b.vocabulary):f(k["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary);var l=k.children.filter(function(a){return a.aggregation===g}).pop();if(l)return d.isRangeVocabulary(b.vocabulary)?f(k["obiba.mica.RangeAggregationResultDto.ranges"],b.vocabulary):f(k["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary)}}return f([],b.vocabulary)}}]),/**
