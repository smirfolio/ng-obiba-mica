...
return e?(g.itemTitle=h(e.title),g.itemDescription=h(e.description),g.itemParentTitle=h(d.title),g.itemParentDescription=h(d.description),g.itemTitle||(g.itemTitle=e.name),g.itemParentTitle||(g.itemParentTitle=d.name)):(g.itemTitle=h(d.title),g.itemDescription=h(d.description),g.itemTitle||(g.itemTitle=d.name)),g}function o(a){l.alert({id:"SearchController",type:"danger",msg:m.buildMessage(a),delay:5e3})}function p(a){if(!a||!k[a.toUpperCase()])throw new Error("Invalid type: "+a)}function q(a){var b=":q(match())";switch(a){case k.NETWORKS:return b.replace(/:q/,"network");case k.STUDIES:return b.replace(/:q/,"study");case k.DATASETS:return b.replace(/:q/,"dataset");case k.VARIABLES:return b.replace(/:q/,"variable")}throw new Error("Invalid query type: "+a)}function r(){try{var b=d.search(),c=b.type||k.VARIABLES,e=b.query||q(c);return p(c),(new RqlParser).parse(e),a.search.type=c,a.search.query=e,!0}catch(f){l.alert({id:"SearchController",type:"danger",msg:f.message,delay:5e3})}return!1}function s(){r()&&j[a.search.type]({query:a.search.query},function(b){a.search.result=b,console.log(">>> Response",a.search.result)},o)}var t=function(){$("#taxonomies").collapse("hide")},u=function(b){
// taxonomy filter
