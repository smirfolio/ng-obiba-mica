 ...
 * @returns {Array}
 */
AbstractCriteriaBuilder.prototype.getCriteriaList=function(){return this.criteriaList},/**
 * Node condition visitor
 * @param node
 */
AbstractCriteriaBuilder.prototype.visitCondition=function(a){this.visit(a.args[0]),this.visit(a.args[1])},/**
 * General purpose node visitor
 * @param node
 */
AbstractCriteriaBuilder.prototype.visit=function(a){switch(console.log("Visit",a),a.name){case"and":case"or":this.visitCondition(a);break;case"in":case"out":case"eq":case"le":case"lt":case"ge":case"gt":case"between":this.visitLeaf(a);break;case"not":case"match":}},/**
 * Builds a criteria list for this target
 */
AbstractCriteriaBuilder.prototype.build=function(){var a=this;this.root.args.forEach(function(b){a.visit(b)})};/**
 ...
 * @returns {*}
 */
RqlQueryBuilder.prototype.node=function(a,b,c){var d=":name(:f,(:args))".replace(/:name/,a).replace(/:f/,b).replace(/:args/,c.join(","));return this.rqlParser.parse(d).args[0]},/**
...
angular.module("obiba.mica.search").factory("TaxonomiesSearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesSearchResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomiesResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("JoinQuerySearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQuerySearchResource"),{},{variables:{method:"GET",errorHandler:!0,params:{type:"variables"}},studies:{method:"GET",errorHandler:!0,params:{type:"studies"}},networks:{method:"GET",errorHandler:!0,params:{type:"networks"}},datasets:{method:"GET",errorHandler:!0,params:{type:"datasets"}}})}]).factory("JoinQueryCoverageResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQueryCoverageResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("VocabularyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("VocabularyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).service("ObibaSearchConfig",function(){var a={networks:null,studies:null,datasets:null,variables:null};this.setOptions=function(b){"object"==typeof b&&Object.keys(b).forEach(function(c){c in a&&(a[c]=b[c])})},this.getOptions=function(){return angular.copy(a)}}).service("RqlQueryService",["$q","TaxonomiesResource","LocalizedValues",function(a,b,c){/**
       ...
       * @returns {boolean}
       */
function d(a,b){if(console.log("findNode",a),a instanceof RqlQuery){
//var that = this;
if(b.accept(a))return!0;a.args&&a.args.some(function(a){return d(a,b)})}return!1}/**
       * Finds a query node by name
       * @param root
       * @param name
       * @returns {null|*}
       */
function e(a,b){var c=new FindNodeVisitor(b);return d(a,c),c.getNode()}
...
var f=null;/**
       ...
       */
this.createCriteria=function(a,b,d,e,f){var g=b.name+"::"+d.name;e&&(g=g+":"+e.name);var h={id:g,taxonomy:b,vocabulary:d,term:e,target:a,lang:f,itemTitle:"",itemDescription:"",itemParentTitle:"",itemParentDescription:""};
// prepare some labels for display
return e?(h.itemTitle=c.forLocale(e.title,f),h.itemDescription=c.forLocale(e.description,f),h.itemParentTitle=c.forLocale(d.title,f),h.itemParentDescription=c.forLocale(d.description,f),h.itemTitle||(h.itemTitle=e.name),h.itemParentTitle||(h.itemParentTitle=d.name)):(h.itemTitle=c.forLocale(d.title,f),h.itemDescription=c.forLocale(d.description,f),h.itemParentTitle=c.forLocale(b.title,f),h.itemParentDescription=c.forLocale(b.description,f),h.itemTitle||(h.itemTitle=d.name),h.itemParentTitle||(h.itemParentTitle=b.name)),h},/**
       * Finds the variable query node
       * @param root
       * @returns {null|*}
       */
this.variableNode=function(a){return e(a,"variable")},/**
       * Builds the variable query criterias
       * @param root
       * @param lang
       * @returns {*}
       */
this.buildVariableCriteria=function(c,d){function e(){var a=g.variableNode(c);if(a){var b=new VariableCriteriaBuilder(a,g.variableTaxonomies,g.createCriteria,d);b.build(),console.log("Criterias:",b.getCriteriaList()),h.resolve(b.getCriteriaList())}}var g=this,h=a.defer();return f?e():b.get({target:"variable"}).$promise.then(function(a){g.variableTaxonomies=a,e()}),h.promise},/**
