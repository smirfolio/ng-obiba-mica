...
variable:"variables",study:"studies",network:"networks",dataset:"datasets"};var H=Object.keys(a.taxonomyTypeMap).reduce(function(b,c){return b[a.taxonomyTypeMap[c]]=c,b},{});a.targets=[],a.lang=p.getLocal(),a.metaTaxonomy=h.get({target:"taxonomy",taxonomy:"Mica_taxonomy"},function(b){a.targets=b.vocabularies.map(function(a){return a.name})});var I={variable:a.options.variables.showSearchTab,dataset:a.options.datasets.showSearchTab,study:a.options.studies.showSearchTab,network:a.options.networks.showSearchTab},J=function(){var a=e.search();delete a.query,e.search(a)},K=function(){a.search.advanced=!a.search.advanced};a.setLocale=function(b){a.lang=b,s.setLocale(a.lang),F()};var L=function(b,c){return a.target===b&&a.taxonomyName===c&&a.taxonomiesShown?void(a.taxonomiesShown=!1):(a.taxonomiesShown=!0,a.target=b,void(a.taxonomyName=c))},M=function(){a.target=null,a.taxonomyName=null},N=function(){var b=(new RqlQuery).serializeArgs(a.search.rqlQuery.args),c=e.search();""===b?delete c.query:c.query=b,e.search(c)},O=function(){a.documents.search.text=null,a.documents.search.active=!1},P=function(b){
